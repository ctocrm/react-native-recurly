...
| Subscriptions | `app/(tabs)/subscriptions.tsx`        | Full list: search, All/Upcoming, expand/edit/delete/stats, **long-press card icon → picker** | `SafeAreaView` + `p-5`. List `pb-25`. **No header `+` (Phase 2).**                                                                                                                                                 | None today                                                                  |
...
| --------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| `CreateSubscriptionModal.tsx`                       | New sub: name + autocomplete + live crawled icon, price, Monthly/Yearly, category. `await onCreate` then fire-and-forget `startIconCrawl`. Submit is **pinned outside** the `ScrollView` (`px-5 pb-5 pt-2`, `accessibilityLabel="Create Subscription"`). | Home header `+` only                                                          | **Yes.** Pinned Create button sits under tab bar + Android nav. KeyboardAvoidingView is iOS-only. |
